...
#sleep 1
#tmux send-keys "addNow 10.0.0.0/8 8 60002" C-m
#sleep 10
#tmux send-keys  C-z
#tmux send-keys  "bg" C-m

tmux select-pane -t 0
tmux send-keys "ssh node1.bs1.bgp-srx.emulab2.antd.nist.gov" C-m
tmux send-keys "sudo pkill bgpd" C-m
tmux send-keys "sudo ~/proj-bgp/quaggasrx/bgpd/.libs/bgpd -f ~/srx_test1/node1/bgpd.bgpsec.test.n1 -i /tmp/bgpd$$.pid" C-m

tmux select-pane -t 1
tmux send-keys "ssh node2.bs1.bgp-srx.emulab2.antd.nist.gov" C-m
#tmux send-keys "Lee@A218" C-m
tmux send-keys "sudo pkill bgpd" C-m
tmux send-keys "sudo ~/proj-bgp/quaggasrx/bgpd/.libs/bgpd -i /tmp/bgpd$$.pid -f ~/srx_test1/node2/bgpd.bgpsec.test.n2" C-m

tmux select-pane -t 2
tmux send-keys "ssh node3.bs1.bgp-srx.emulab2.antd.nist.gov" C-m
tmux send-keys "sudo pkill bgpd" C-m
tmux send-keys "sudo ~/proj-bgp/quaggasrx/bgpd/.libs/bgpd -f ~/srx_test1/node3/bgpd.bgpsec.test.n3 -i /tmp/bgpd$$.pid" C-m

tmux select-pane -t 3
tmux send-keys "ssh node4.bs1.bgp-srx.emulab2.antd.nist.gov" C-m
tmux send-keys "sudo pkill bgpd" C-m
tmux send-keys "sudo ~/proj-bgp/quaggasrx/bgpd/.libs/bgpd -f ~/srx_test1/node4/bgpd.bgpsec.test.n4 -i /tmp/bgpd$$.pid" C-m

tmux select-pane -t 4
tmux send-keys "ssh node5.bs1.bgp-srx.emulab2.antd.nist.gov" C-m
tmux send-keys "sudo pkill bgpd" C-m
tmux send-keys "sudo ~/proj-bgp/quaggasrx/bgpd/.libs/bgpd -f ~/srx_test1/node5/bgpd.bgpsec.test.n5 -i /tmp/bgpd$$.pid" C-m


# monitoring from node4
tmux select-pane -t 5
sleep 3
tmux send-keys "telnet node4.bs1.bgp-srx.emulab2.antd.nist.gov 2605" C-m
sleep 1
